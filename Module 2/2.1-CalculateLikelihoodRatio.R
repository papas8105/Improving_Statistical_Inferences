...
H1 <- 8/13 #specify another hypothesis you want to compare with the likehood ratio (you can use 1/20, or 0.05)
print(dbinom(x,n,H0)/dbinom(x,n,H1)) #Returns the likelihood ratio of H0 over H1
...
#dev.off()
# Q4
# > round(dbinom(5,10,0.5)/dbinom(5,10,0.4),2)
# [1] 1.23
# Q5
# > round(dbinom(50,100,0.5)/dbinom(50,100,0.4),2)
# [1] 7.7
# Q6
# >  round(dbinom(500,1000,0.5)/dbinom(500,1000,0.4),2)
# [1] 731784961
#? Daniel Lakens, 2016. 
