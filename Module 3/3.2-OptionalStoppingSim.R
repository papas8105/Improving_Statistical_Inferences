#Default values 
# N = 100, Looks = 5, nsim = 50000, alpha = 0.05 , D = 0
...
alpha<-0.0158                 #set alpha 0.0158 Pocock's α boundary at each look for 5 looks
...
SigSeq<-numeric(Looks) #Variable to store final p-values at each look
